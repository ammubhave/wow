  ...
  return (
    <div className="mx-auto max-w-4xl rounded-lg bg-white p-8 shadow-lg">
      ...
      <p className="mb-6 text-gray-700">
        Welcome to Wafflehäus Organized Workspace ("WOW"). Your privacy is of
        utmost importance to us. This Privacy Policy outlines how we collect,
        use, and protect your information when you interact with our website and
        services.
      </p>
      ...
      <p className="mb-6 text-gray-700">
        ...
        <ul className="ml-6 mt-2 list-disc">
          <li>
            ...
            directly, such as your name, email address, phone number, or payment
            information when creating an account or making purchases.
          </li>
          <li>
          ...
          <li>
            <strong>Third-Party Data:</strong> Information from third-party
            services, such as payment processors, to facilitate transactions.
          </li>
        </ul>
      </p>
      ...
      <p className="mb-6 text-gray-700">
        ...
        <ul className="ml-6 mt-2 list-disc">
          ...
          <li>
            Communicate with you regarding updates, offers, and other news
            related to WOW.
          </li>
      ...
      <p className="mb-6 text-gray-700">
        ...
        <ul className="ml-6 mt-2 list-disc">
          ...
          <li>
            To third-party service providers who help us run our business, such
            as payment processors and hosting services.
          </li>
          <li>
            As required by law, to comply with legal obligations, or in response
      ...
      <p className="mb-6 text-gray-700">
        ...
        <span className="font-semibold">contact@wafflehaus.io</span> to exercise
        your rights.
      </p>

      <h2 className="mb-4 text-2xl font-semibold text-gray-800">6. Cookies</h2>
      <p className="mb-6 text-gray-700">
        WOW uses cookies and similar technologies to enhance your experience.
      ...
      <p className="mb-6 text-gray-700">
        ...
        of any changes by posting the updated policy on our website and updating
        the effective date.
      </p>
