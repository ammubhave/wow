        ...
        <header>
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-4 px-4 sm:justify-between sm:px-6 lg:flex-nowrap lg:px-8">
            ...
            <div className="flex flex-col-reverse flex-wrap items-center gap-4 sm:flex-row">
              ...
              <Button asChild>
                <Link to="/wow">My Workspaces</Link>
              </Button>
            </div>
          </div>
        </header>
            ...
            <div className="mx-auto max-w-2xl lg:max-w-4xl lg:px-12">
              ...
              <div className="text-background mt-6 space-y-6 text-2xl tracking-tight">
                <p className="font-display">
                  Wafflehäus Organized Workspace (WOW) is a platform for puzzle
                  hunt teams to organize when solving puzzles. It provides
                  several automations such as creating google spreadsheets,
                  discord channels, and more.
                </p>
                <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                  <Button asChild>
                    <Link to="/wow">Get Started</Link>
                  </Button>
