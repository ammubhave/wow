...
export const listOptions: ListOption[] = [
  {label: "Bullet List", type: "bulletList", icon: ListIcon},
  {label: "Ordered List", type: "orderedList", icon: ListOrderedIcon},
  {label: "Task List", type: "taskList", icon: ListTodoIcon},
];
