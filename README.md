...
Migrations are generated by `pnpm prisma migrate dev` command.
Migrations are applied to production by `pnpm turso db shell wow < ./prisma/migrations/<migration-name>/migration.sql` command.
